...
static navigationOptions = {
  ...
  renderRowItem = (itemData) => {
    ...
    <View style={{flexDirection:'column', margin:10, width: '82%',}}>
     <Text style={{fontSize:15, color:'#21262C', fontFamily: 'Nunito-SemiBold'}}>{itemData.item.title}</Text>
      <Text style={{fontSize:13, marginRight:10,fontFamily: 'Nunito-Regular'}}>{itemData.item.message}</Text>
