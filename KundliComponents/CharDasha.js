    ...
    constructor(props){
        ...
        this.state = {
            ...
            categories:[ 
                {"key": "0",
                 "name": "Major Dasha",
                 "param": "major_chardasha",
                 "is_selected":"1",
                },
                {"key": "1",
                 "name": "Current Dasha",
                 "param": "current_chardasha",
                 "is_selected":"0",
                },
            ],
            index:"0",
...
//                    alert(this.state.param)
  ...
  componentDidMount(){
    this.getChar('major_chardasha')
  }


  getChar=(typeCharshottari)=>{
//    alert(typeCharshottari)
//    this.showLoading()
        ...
        fetch(url, {
            ...
            "api-condition": typeCharshottari,
  ...
  //             this.hideLoading()
                ...
                if (responseJson.status == true) {
                    ...
                    if(typeCharshottari == 'major_chardasha'){
    ...
    <Text style={{fontFamily:'Nunito-Regular',width:'20%',backgroundColor:'transparent', fontSize:14, color: 'grey', marginLeft:wp(2.5), textAlign:'left'}}>{item.sign_name}</Text>
    <Text style={{fontFamily:'Nunito-Regular',width:'25%',backgroundColor:'transparent', fontSize:14, color:'grey', textAlign:'left', }}>{item.start_date}</Text>
    <Text style={{fontFamily:'Nunito-Regular',width:'25%',backgroundColor:'transparent', fontSize:14, color:'grey', textAlign:'left', }}>{item.end_date}</Text>
    <Text style={{fontFamily:'Nunito-Regular',width:'25%',backgroundColor:'transparent', fontSize:14, color:'grey', textAlign:'left', marginRight:wp(1.5)}}>{item.duration}</Text>
    </View>
  ...
  return(
    ...
    <Text style={{fontFamily:'Nunito-Bold', fontSize:22,marginTop:5, alignSelf:'center'}}>Char Dasha</Text>
    <Text style={{fontFamily:'Nunito-Regular', fontSize:16,color:'#838383', marginTop:10}}>
    Char dasha is also known as Jamini Dasha and useful for predictions. This is dasha based
    on rashi chakra ie. zodiac cycle.
   ...
   <>
    ...
    <Text style={{fontFamily:'Nunito-ExtraBold',width:'80%',backgroundColor:'transparent', fontSize:17, color:'white', marginLeft:wp(4.5), textAlign:'left'}}>Major Chardasha</Text>
    </View>
...
*/}
        ...
        <CharBlocks CharColors={['#ef9a9a','#3d0984']}
        CharTitle={'Major Charshottari Dasha'}
        CharPlanet={allGet.major.sign_name}
        CharStart={allGet.major.start_date}
        CharEnd={allGet.major.end_date}
        CharDu={allGet.major.duration}
        />


        <CharBlocks CharColors={['#ffe791', '#f7005d']}
        CharTitle={'Antardasha'}
        CharPlanet={allGet.sub_minor.sign_name}
        CharStart={allGet.sub_minor.start_date}
        CharEnd={allGet.sub_minor.end_date}
        CharDu={allGet.sub_minor.duration}        
        />

        <CharBlocks CharColors={['#ffd0bb', '#086888']}
        CharTitle={'Pratyantardasha'}
        CharPlanet={allGet.sub_sub_minor.sign_name}
        CharStart={allGet.sub_sub_minor.start_date}
        CharEnd={allGet.sub_sub_minor.end_date}
        CharDu={'-'}        
        />
...
class CharBlocks extends Component{
    render(){
        return(
...
<LinearGradient colors={this.props.CharColors}
start={{x: 0, y: 0}} end={{x: 1, y: 0}}
 ...
 >
    ...
    <View style={{flexDirection:'column', margin:10}}>
          ...
          {this.props.CharPlanet}</Text>
          </Text>

          <Text style = {{fontSize:16,marginBottom:0,fontFamily:'Nunito-SemiBold',color:'#E60000',}}>
          Start Date : <Text style={{color:'#293440'}}>
          {this.props.CharStart}</Text>
          </Text>

          <Text style = {{fontSize:16,marginBottom:0,fontFamily:'Nunito-SemiBold',color:'#E60000',}}>
          End Date : <Text style={{color:'#293440'}}>
          {this.props.CharEnd}</Text>
          </Text>

          <Text style = {{fontSize:16,marginBottom:0,fontFamily:'Nunito-SemiBold',color:'#E60000',}}>
          Duration : <Text style={{color:'#293440'}}>
          {this.props.CharDu}</Text>
          </Text>
