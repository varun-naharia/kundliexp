...
export default class DailyPanchang extends Component{
  ...
  componentDidMount(){
      this.getPanchangDetails(GLOBAL.gldate, GLOBAL.glmonth, GLOBAL.glyear)
  }

    getPanchangDetails= (getDate, getMonth, getYear) =>{
      this.showLoading()
    ...
    dateSelection = (date)=>{
        ...
        var sel_date = t.getDate()
        var sel_mon = t.getMonth()+1
        var sel_yr = t.getFullYear() 
        console.warn(sel_date + '--'+ sel_mon+'--'+ sel_yr)
        this.getPanchangDetails(sel_date, sel_mon, sel_yr)
    }
  ...
           headerName={'DAILY PANCHANG'}
    ...
    <ScrollView>
        ...
        <CalendarStrip
            ...
            onDateSelected={(date)=> this.dateSelection(date)}
        />
